...
//Serial.print("keyboard bagan");
  ...
  if (handlebar > (wheelcenter+23)) { //handlebar turns right, turn kart right
...
//      Keyboard.write(turnRight); //press the key again
  ...
  else if (handlebar < (wheelcenter-23)) { //handlebar turns left, turn left
...
//      Keyboard.write(turnLeft); //press the key again
   ...
   if(handlebar <=(wheelcenter+23) && handlebar >=(wheelcenter-23)){
